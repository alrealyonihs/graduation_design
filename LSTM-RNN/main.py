...
import datetime
import torch
from model import LSTM_RNN, Transformer,LSTMModel
...
FILE = "/home/liuyanling/Code/mouse_dynamics_balabit_chaoshen_dfl-master/LSTM-RNN/data/MNIST/raw/balabit_39feat_PC_MM_DD_1000.csv"
...
if __name__ == "__main__":
    ...
    #log path
    log_filename = '/home/liuyanling/Code/mouse_dynamics_balabit_chaoshen_dfl-master/LSTM-RNN/log/'+datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")+'.log'
    logger = logger_setup(log_filename)
    logger.info(f'lr:{LEARNING_RATE},weight_decay:{WEIGHT_DECAY},batch_size:{BATCH_SIZE}')
    logger.info(model)

    #write csv
    csv_filename = '/home/liuyanling/Code/mouse_dynamics_balabit_chaoshen_dfl-master/LSTM-RNN/csv_record/'+datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")+'.csv'

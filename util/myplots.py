...
def plotROC_index(fpr, tpr, roc_auc, index):
    ...
    plt.show()
    # filename = '/home/liuyanling/Code/mouse_dynamics_balabit_chaoshen_dfl-master/ROC/ROC'+str(index)+'.png'
...
def plotROCs(fpr, tpr, roc_auc, items, plot_user_auc = False):
    ...
    plt.legend(loc="lower right")
    plt.show()
    # filename = '/home/liuyanling/Code/mouse_dynamics_balabit_chaoshen_dfl-master/ROC/ROC'+str(items)+'.png'
    # plt.savefig(filename)
